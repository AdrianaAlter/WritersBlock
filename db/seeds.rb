...
bg32 = Prize.create({name: 'northern', category: 'background', price: 12})
bg33 = Prize.create({name: 'royal', category: 'background', price: 12})
bg34 = Prize.create({name: 'salvage', category: 'background', price: 12})
bg35 = Prize.create({name: 'steadfast', category: 'background', price: 12})
bg36 = Prize.create({name: 'haunted', category: 'background', price: 12})
bg32 = Prize.create({name: 'medallion', category: 'background', price: 12})
bg33 = Prize.create({name: 'medusa', category: 'background', price: 12})
bg34 = Prize.create({name: 'queen', category: 'background', price: 12})
bg35 = Prize.create({name: 'antoinette', category: 'background', price: 12})
bg36 = Prize.create({name: 'avalon', category: 'background', price: 12})
bg32 = Prize.create({name: 'battle', category: 'background', price: 12})
bg33 = Prize.create({name: 'coaster', category: 'background', price: 12})
